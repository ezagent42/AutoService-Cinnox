"""
Data import utilities for skill domains.
...
from autoservice.core import generate_id, ensure_dir
...
def import_file(file_path: str, output_dir: str, item_type: str) -> list[Path]:
    ...
    Args:
        file_path: Path to DOCX, PDF, or XLSX file
        output_dir: Directory to save imported items
        item_type: Type of items ('product', 'customer', 'operator')

    Returns:
        List of paths to created item directories
    """
